...
#define CBOR_AND_OTHER_HDR                                                                         \
	(MGMT_HDR_SIZE + (9 + 1) + (1 + 3 + CONFIG_LCZ_FS_MGMT_MAX_OFFSET_LEN) +                   \
	 (1 + 4 + CONFIG_LCZ_FS_MGMT_MAX_OFFSET_LEN) + (1 + 2 + 1) +                               \
	 (1 + 3 + CONFIG_LCZ_FS_MGMT_MAX_OFFSET_LEN))

#if defined(CONFIG_LCZ_FS_MGMT_DL_CHUNK_SIZE_LIMIT)
#if (CONFIG_LCZ_FS_MGMT_DL_CHUNK_SIZE + CBOR_AND_OTHER_HDR) > CONFIG_MCUMGR_BUF_SIZE
