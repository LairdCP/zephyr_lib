...
/**
 * @brief Called when a reboot command has been received, prior to the
 * timer elapsing. Can be overridden in the application to clean up or save
 * state.
 *
 * @param delay_ms              Time (in ms) until reboot occurs
 */
void app_received_reboot_command(unsigned int delay_ms);

/**
 * @brief Called prior to an OS reset is executed. Can be overridden in
 * the application to clean up or save state.
 */
