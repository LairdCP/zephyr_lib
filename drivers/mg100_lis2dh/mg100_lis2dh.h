...
#elif defined(CONFIG_MG100_LIS2DH_ODR_4) || defined(CONFIG_MG100_LIS2DH_ODR_RUNTIME)
...
#elif defined(CONFIG_MG100_LIS2DH_ODR_9_NORMAL) || defined(CONFIG_MG100_LIS2DH_ODR_9_LOW)
...
struct lis2dh_data {
	...
	K_THREAD_STACK_MEMBER(thread_stack, CONFIG_MG100_LIS2DH_THREAD_STACK_SIZE);
