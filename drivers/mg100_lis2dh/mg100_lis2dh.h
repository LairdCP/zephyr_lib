...
#define LIS2DH_ACCEL_EN_BITS                                                   \
	(LIS2DH_ACCEL_X_EN_BIT | LIS2DH_ACCEL_Y_EN_BIT | LIS2DH_ACCEL_Z_EN_BIT)
#define LIS2DH_ACCEL_XYZ_MASK BIT_MASK(3)

#define LIS2DH_LP_EN_BIT_MASK BIT(3)
#if defined(CONFIG_MG100_LIS2DH_OPER_MODE_LOW_POWER)
...
#if defined(CONFIG_MG100_LIS2DH_ODR_1)
#define LIS2DH_ODR_IDX LIS2DH_ODR_1
#elif defined(CONFIG_MG100_LIS2DH_ODR_2)
#define LIS2DH_ODR_IDX LIS2DH_ODR_2
#elif defined(CONFIG_MG100_LIS2DH_ODR_3)
#define LIS2DH_ODR_IDX LIS2DH_ODR_3
#elif defined(CONFIG_MG100_LIS2DH_ODR_4) ||                                    \
	defined(CONFIG_MG100_LIS2DH_ODR_RUNTIME)
#define LIS2DH_ODR_IDX LIS2DH_ODR_4
#elif defined(CONFIG_MG100_LIS2DH_ODR_5)
#define LIS2DH_ODR_IDX LIS2DH_ODR_5
#elif defined(CONFIG_MG100_LIS2DH_ODR_6)
#define LIS2DH_ODR_IDX LIS2DH_ODR_6
#elif defined(CONFIG_MG100_LIS2DH_ODR_7)
#define LIS2DH_ODR_IDX LIS2DH_ODR_7
#elif defined(CONFIG_MG100_LIS2DH_ODR_8)
#define LIS2DH_ODR_IDX LIS2DH_ODR_8
#elif defined(CONFIG_MG100_LIS2DH_ODR_9_NORMAL) ||                             \
	defined(CONFIG_MG100_LIS2DH_ODR_9_LOW)
...
#if defined(CONFIG_MG100_LIS2DH_ACCEL_RANGE_2G) ||                             \
	defined(CONFIG_MG100_LIS2DH_ACCEL_RANGE_RUNTIME)
#define LIS2DH_FS_IDX 0
#elif defined(CONFIG_MG100_LIS2DH_ACCEL_RANGE_4G)
#define LIS2DH_FS_IDX 1
#elif defined(CONFIG_MG100_LIS2DH_ACCEL_RANGE_8G)
#define LIS2DH_FS_IDX 2
#elif defined(CONFIG_MG100_LIS2DH_ACCEL_RANGE_16G)
#define LIS2DH_FS_IDX 3
#endif

#define LIS2DH_FS_SELECT(fs) ((fs) << LIS2DH_FS_SHIFT)
#define LIS2DH_FS_BITS (LIS2DH_FS_SELECT(LIS2DH_FS_IDX))
#if defined(CONFIG_MG100_LIS2DH_OPER_MODE_HIGH_RES)
...
#ifdef CONFIG_MG100_LIS2DH_TRIGGER
...
#endif /* CONFIG_MG100_LIS2DH_TRIGGER */
#if DT_INST_SPI_DEV_HAS_CS_GPIOS(0)
...
#if DT_ANY_INST_ON_BUS_STATUS_OKAY(spi)
int lis2dh_spi_access(struct lis2dh_data *ctx, uint8_t cmd, void *data,
		      size_t length);
#endif
