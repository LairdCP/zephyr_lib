				...
				uint8_t *value, uint8_t len)
{
	...
	return i2c_burst_read(data->bus, cfg->i2c_slv_addr,
			      reg_addr | LIS2DH_AUTOINCREMENT_ADDR, value, len);
}
				 ...
				 uint8_t *value, uint8_t len)
{
	...
	return i2c_burst_write(data->bus, cfg->i2c_slv_addr,
			       reg_addr | LIS2DH_AUTOINCREMENT_ADDR, value,
			       len);
}
			       ...
			       uint8_t *value)
{
	...
	return i2c_reg_read_byte(data->bus, cfg->i2c_slv_addr, reg_addr, value);
}
				...
				uint8_t value)
{
	...
	return i2c_reg_write_byte(data->bus, cfg->i2c_slv_addr, reg_addr,
				  value);
}
				 ...
				 uint8_t mask, uint8_t value)
{
	...
	return i2c_reg_update_byte(data->bus, cfg->i2c_slv_addr, reg_addr, mask,
				   value);
}
